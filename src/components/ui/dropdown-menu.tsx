...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronRightIcon className="noml-auto noh-4 now-4" />
  </DropdownMenuPrimitive.SubTrigger>
))
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "noz-50 nomin-w-[8rem] nooverflow-hidden norounded-md noborder nobg-popover nop-1 notext-popover-foreground noshadow-md",
        "data-[state=open]:noanimate-in data-[state=closed]:noanimate-out data-[state=closed]:nofade-out-0 data-[state=open]:nofade-in-0 data-[state=closed]:nozoom-out-95 data-[state=open]:nozoom-in-95 data-[side=bottom]:noslide-in-from-top-2 data-[side=left]:noslide-in-from-right-2 data-[side=right]:noslide-in-from-left-2 data-[side=top]:noslide-in-from-bottom-2",
        className
      )}
      {...props}
    />
  ...
  >
    <span className="noabsolute noleft-2 noflex noh-3.5 now-3.5 noitems-center nojustify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        <CheckIcon className="noh-4 now-4" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.CheckboxItem>
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span className="noabsolute noleft-2 noflex noh-3.5 now-3.5 noitems-center nojustify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        <DotFilledIcon className="noh-4 now-4 nofill-current" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
